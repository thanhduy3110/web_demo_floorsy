...
<body>
    ...
    <div class="main">
        ...
        <form action="" method="POST" class="form" id="contactForm" name="myForm" onsubmit="return(validate());">
            ...
            <button type="submit" id="btnContact" class="form-submit">Đăng ký</button>
        </form>
